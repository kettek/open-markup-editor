...
app.on('ready', () => {
  ...
  if (!settings.has("filetypes")) settings.set("filetypes", {"md": "$OME_MARKUP_PACKS/markdown-it" });
  if (!settings.has("renderpack")) settings.set("renderpack", "$OME_RENDER_PACKS/default");
  // ---- ----
